      ...
      <div className="mb-10 mt-24">
          ...
          <div className="flex flex-col w-2/4 m-5  max-md:w-full">
            <div className="w-full flex flex-col items-center justify-center">
              <div className="flex flex-col items-center justify-center p-3 shadow-lg rounded-lg">
                ...
                <div className="pt-5 pb-5 pl-5 pr-5 mt-3 mb-5 shadow-lg rounded-lg">
                  <p>
                    <strong>Address:</strong> Sonarpur ,
                    Kolkata, India
                  </p>
                  <p>
                    <strong>Phone:</strong> +91 8584027372
                  </p>
                  <p>
                    <strong>Email:</strong> souravgiri697@gmail.com
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex w-full flex-row items-center justify-center">
              <div className="w-full p-5">
                ...
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7374.996473984091!2d88.37961468870367!3d22.447903834242222!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a027194ff830f15%3A0xe8f8d7ce61e4d2a6!2sPearabagan%2C%20Kamalgachhi%20More%2C%20Kolkata%2C%20West%20Bengal%20700153!5e0!3m2!1sen!2sin!4v1720891577101!5m2!1sen!2sin"
                  allowFullScreen=""
                  loading="lazy"
          ...
          <div className="flex flex-col w-2/4 items-center justify-center max-md:w-full max-md:mt-10">
            ...
            <div className="flex flex-col items-start justify-center p-5">
              <Accordion
                ...
                content={
                  "Booking a tour is simple. Browse our tour packages, select your preferred tour, and contact us via the form or call +91 8584027372. Complete your booking and payment online."
                }
              />
              <Accordion
        ...
        <div className="flex flex-row items-center justify-center">
          <p className="text-center">
            ...
            emergencies, please call: +91 8584027372
          </p>
        </div>
      </div>
    </>
